package code {
	...
	public class AABB {
		...
		public function AABB(halfWith:Number, halfHeight:Number) {
			// constructor code
			setSize(halfWidth, halfHeight);
		}
		
		public function setSize(halfWith:Number, halfHeight:Number):void{
		...
		public function checkOverlap(other:AABB):Boolean{
			...
			if(this.xmax < other.xmin) return false;// gap to the right of this box
